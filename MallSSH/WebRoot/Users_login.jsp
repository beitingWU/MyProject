...
<%@ taglib prefix="s" uri="/struts-tags"%><!-- 标签库 -->
<%
...
<div id="wrapper">
	...
	<div id="main">
		<div id="mainBg">
			<div id="mainPanel">
				<div id="left">
					<div id="image"><img src="images/admin.png"/></div>
				</div>
				<div id="right">
					
					<form name="adminLogin" method="post" onsubmit="return checkForm(this);" action="<%=path %>/adminLogin.action">
					<div id="welcome">
					...
					<div id="user-password">
						...
						<span class="input"><input type="password" name="userPw" class="form-input"></span>
					    
					</div>
					<div style="margin-left: 30px;color: red"><s:property value="message"/></div>
					<div id="button-group">
