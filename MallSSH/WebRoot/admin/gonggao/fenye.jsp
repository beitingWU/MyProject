...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body leftmargin="2" topmargin="2" background='<%=path %>/images/allbg.gif'>
			<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
				<tr bgcolor="#E7E7E7">
					<td height="14" colspan="4" background="<%=path %>/images/slider_bg.gif">&nbsp;公告&nbsp;</td>
				</tr>
				...
				<s:iterator value="#request.gonggaoListfenye" id="gonggao">
				<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
					...
					<td bgcolor="#FFFFFF" align="center">
					 ...
					 <a href="<%=path %>/gonggaoDetail.action?gonggaoId=<s:property value="#gonggao.gonggaoId"/>" class="pn-loperator">查看内容</a>
					</td>
					<td bgcolor="#FFFFFF" align="center">
			...
			<!-- fenye -->
		<%--  <s:url id="url_pre" value="fenye.action">  
             <s:param name="pageNow" value="pageNow-1"></s:param>  
         </s:url>  
      
         <s:url id="url_next" value="fenye.action">  
             <s:param name="pageNow" value="pageNow+1"></s:param>  
         </s:url>    
      
         <s:a href="%{url_pre}">上一页</s:a>  
           
        <s:iterator value="#request.gonggaoListfenye" id="gonggao" status="status">
            <s:url id="url" value="fenye.action">  
