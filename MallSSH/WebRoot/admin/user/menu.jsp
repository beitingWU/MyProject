...
<%-- 	<link rel="stylesheet" href="<%=path %>/css/menu.css" type="text/css" /> --%>
	<style type="text/css">
		...
		dl.bitem dt {
		  background:url(<%=path %>/images/left_bg_bottom.jpg) /* left no-repeat btn_1.png */;
	...
	<table width='99%' height="100%" border='0' cellspacing='0' cellpadding='0'>
	  <tr>
	    <td style='padding-left:3px;padding-top:8px' valign="top">
		  <!-- 1 -->
	      <dl class='bitem'>
	        <dt onClick='showHide("items1_1")'><b style="color: black">基本操作</b></dt>
	      ...
	      <!-- 1 -->
	      <dl class='bitem'>
	        <dt onClick='showHide("items7_1")'><b>订单管理</b></dt>
	      ...
	      <dl class='bitem'>
	        ...
	        <dd style='display:block' class='sitem' id='items99_1'>
	          <ul class='sitemu'>
	            <li><a href='#' onclick='javascript:window.parent.location="<%=path %>/Users_login.jsp"'>安全退出系统</a></li>
	          </ul>
	        </dd>
	      </dl>
	      <!-- 1 -->
