...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
        ...
        <script language="javascript">
	       ...
	       {
			  if (picPath=="")picPath="/images/bhj.jpg";
			  x = event.clientX;
			  y = event.clientY;      
	...
	<body leftmargin="2" topmargin="2" background='<%=path %>/images/allbg.gif'>
			<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
				<tr bgcolor="#E7E7E7">
					<td height="14" colspan="9" background="<%=path %>/images/slider_bg.gif">&nbsp;在线商品&nbsp;</td>
				</tr>
				...
				<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
					...
					<td bgcolor="#FFFFFF" align="center">
					   <a href="<%=path %>/goodsDetailHou.action?goodsId=<s:property value="#goods.goodsId"/>" class="pn-loperator">查看商品描述</a>				
					</td>
					<td bgcolor="#FFFFFF" align="center">
					    <s:property value="#goods.goodsCatelogName"/>
					</td>
					<td bgcolor="#FFFFFF" align="center">		  
					  <img width="100px" height="100px" src="..<%=path %><s:property value='#goods.goodsPic'/>"/>				
					</td>
					<td bgcolor="#FFFFFF" align="center">
