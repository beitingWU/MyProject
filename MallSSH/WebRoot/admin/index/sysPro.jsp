...
<%@ page import="java.lang.management.ManagementFactory" %><!-- sun.management.ManagementFactory java.lang.management.ManagementFactory-->
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body leftmargin="2" topmargin="9" background='<%=path %>/images/allbg.gif'>
	    <table width="98%" align="center" border="0" cellpadding="4" cellspacing="1" bgcolor="#D1DDAA" style="margin-bottom:8px">
		  <tr bgcolor="#EEF4EA">
		    <td colspan="2" background="<%=path %>/images/slider_bg.gif" class='title'><span>系统基本信息</span></td>
		  </tr><!-- tbg.gif -->
		  <tr bgcolor="#FFFFFF">
		  ...
		  <tr bgcolor="#FFFFFF">
		    <td width="25%" style="color:#FFFFFF" bgcolor="#6495ED" align="right">总内存/剩余内存：</td>
		    <td bgcolor="#6495ED" style="color:#FFFFFF">
