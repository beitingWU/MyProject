...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body leftmargin="2" topmargin="2" background='<%=path %>/images/allbg.gif'>
			<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
				<tr bgcolor="#E7E7E7">
					<td height="14" colspan="7" background="<%=path %>/images/tbg.gif">&nbsp;订单管理&nbsp;</td>
				</tr>
				...
				<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
					<td bgcolor="#FFFFFF" align="center">
					    ...
					    <a href="<%=path %>/userXinxi.action?userId=<s:property value="#order.orderUserId"/>" class="pn-loperator"><s:property value="#order.orderUserId"/></a>
					...
					<td bgcolor="#FFFFFF" align="center">
						   ...
						   <a href="<%=path %>/adminDetail.action?orderId=<s:property value="#order.orderId"/>" class="pn-loperator">订单明细</a>				
