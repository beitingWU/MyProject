...
<head>
 ...
 {                                                                                         
	 ...
	 if(document.adminLogin.userPw.value=="")
	 {
	 	alert("请输入密码");
	 ...
	 //loginService.login(document.adminLogin.userName.value,document.adminLogin.userPw.value,0,callback);
 }
...
<body>
	...
	<table width="559" height="423" border="0" align="center" cellpadding="0" cellspacing="0"  background="<%=path %>/images/dfff.jpg"> 
	 <tr>
	    <td><div align="center" style="FONT-WEIGHT: bold; FONT-SIZE: 40pt;">淘淘销售系统</div></td>
	 </tr>	 
	 <tr>
		<td width="559">		    
			<form name="adminLogin" method="post" action="<%=path %>/adminLogin.action">
