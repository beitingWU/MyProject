		             ...
		             <div class="list pic_news">
	                        ...
	                        <table width="99%" border="0" cellpadding="2" cellspacing="1" bgcolor="#FFFFFF" align="center" style="margin-top:8px">
								  ...
								  <tr align='center' bgcolor="#FFFFFF" height="22">
									  ...
									  <td><input style="width:20px;" type="button" value="-" onclick="min()"/><input type="text" class="textBox" onChange="modiNum(<s:property value="value.goods.goodsId"/>,this.value)" value="<s:property value="value.goodsQuantity"/>" size="4"/><input style="width:20px;" type="button" value="+" onclick="add()"/></td>
