...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript">
	        ...
	        function add() 
			{	
			    document.buy.quantity.value=(parseInt(document.buy.quantity.value) + 1);    
			}
	    </script>
	</head>
						  	...
						  	<form action="<%=path %>/addToCart.action" method="post" name="buy">
                                  <table border="0" cellpadding="6">
                                      ...
                                      <tr><td width="30"></td><td style="font-size: 11px;">购买数量：</td><td style="font-size: 11px;">
                                          <input style="width:20px;" type="button" value="-" onclick="min()"/>
                                          <input type="text" name="quantity" value="1" size="8" style="width:30px;" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')"/>
                                          <input style="width:20px;" type="button" value="+" onclick="add()"/></td></tr>                                     </td></tr>
